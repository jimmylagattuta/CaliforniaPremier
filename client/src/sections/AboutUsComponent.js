  ...
  return (
    <section className="about-section">
      ...
      <div className="about-content">
        ...
        <img
          src="https://i.postimg.cc/qB3ZY64r/i-Stock-1443170756-1-1.webp"
          alt="About Us"
          loading="lazy"
